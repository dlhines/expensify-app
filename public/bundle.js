...
var IndecisionApp = function (_React$Component) {
    ...
    function IndecisionApp() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = IndecisionApp.__proto__ || Object.getPrototypeOf(IndecisionApp)).call.apply(_ref, [this].concat(args))), _this), _this.state = { options: [] }, _this.handleAddOption = function (option) {
            if (!option) {
            ...
            _this.setState(function (prevState) {
                return {
                    // Using the concat method you actuall do not manipulate the prevState nor the original value as
                    // you would with prevState.options.push(option)
                    options: prevState.options.concat(option)
                };
            });
            // This was used before watching lecture 45
        ...
        }, _this.handelDeleteOptions = function () {
...
var Options = function Options(props) {
    return _react2.default.createElement(
        ...
        props.options.length === 0 && _react2.default.createElement(
            'p',
            null,
            'No Options. Add Some Options...'
        ),
        props.options.map(function (option) {
            return _react2.default.createElement(_Option2.default, { key: option, optionText: option, handleDeleteOptionSingular: props.handleDeleteOptionSingular });
        })
    );
};
